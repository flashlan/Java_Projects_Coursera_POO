...
// código desorganizado (para refatorar)
...
public class Empregado {
	...
	public static void main(String[] args) {
		...
		trabalhador2.pagamentoPorHora = 100;
		...
		for (int i = 0; i < 3; i++) {
			...
			case MENSALISTA:
				custoTotal += trabalhador.salarioMensal * trabalhador.taxaEncargosTrabalhistas;
				break;
			case HORISTA:
				custoTotal += trabalhador.pagamentoPorHora * trabalhador.horasTrabalhadas;
				break;
			case AVULSO:
	...
	System.out.println("Minha folha de pagamento vai custar" + custoTotal);
	}
